...
@property (strong, nonatomic) UIButton *ZButton;
...
- (UIButton *)XButton {
    if (!_XButton) {
        ...
        _XButton.backgroundColor = [UIColor blueColor];
        [_XButton setTitle:@"X" forState:UIControlStateNormal];
        [_XButton addTarget:self action:@selector(XClick:) forControlEvents:UIControlEventTouchUpInside];
    }
    return _XButton;
}
...
- (UIButton *)YButton {
    if (!_YButton) {
        _YButton = [UIButton buttonWithType:UIButtonTypeCustom];
        _YButton.backgroundColor = [UIColor blueColor];
        [_YButton setTitle:@"Y" forState:UIControlStateNormal];
        [_YButton addTarget:self action:@selector(YClick:) forControlEvents:UIControlEventTouchUpInside];
    }
    return _YButton;
}
...
- (UIButton *)ZButton {
    if (!_ZButton) {
        _ZButton = [UIButton buttonWithType:UIButtonTypeCustom];
        _ZButton.backgroundColor = [UIColor blueColor];
        [_ZButton setTitle:@"Z" forState:UIControlStateNormal];
        [_ZButton addTarget:self action:@selector(ZClick:) forControlEvents:UIControlEventTouchUpInside];
    }
    return _ZButton;
}
