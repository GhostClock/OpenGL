...
@property(nonatomic, strong) GLKBaseEffect *cEffect;
...
-(void)setUpTexture
{
    ...
    self.cEffect = [[GLKBaseEffect alloc]init];
    self.cEffect.texture2d0.enabled = GL_TRUE;
    self.cEffect.texture2d0.name = textureInfo.name;
}
